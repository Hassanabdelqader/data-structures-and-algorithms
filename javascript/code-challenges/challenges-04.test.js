...
const alphabetizeBetter = (arr) => {
  ...
  arr.sort((a, z) => {
    if (a.toLowerCase() > z.toLowerCase()) {
      return 1;
    } else if (a.toLowerCase() < z.toLowerCase()) {
      return -1;
    }
    else {

        for (let x = 1; x < Math.min(a.length ,z.length); x++) {
          if (a[x] > z[x]) {
            return 1;
          } else if (a[x] < z[x]) {
            return -1;
...
const sortPeople = (arr) => {
  ...
  arr.sort((a, z) => {
    if (a.lastName.toLowerCase() > z.lastName.toLowerCase()) {
      return 1;
    } else if (a.lastName.toLowerCase() < z.lastName.toLowerCase()) {
      return -1;
    }
    else {
          for (let x = 1; x < Math.min( a.lastName.length,z.lastName.length); x++) {
              if (a[x] > z[x]) {
                return 1;
              } else if (a[x] < z[x]) {
                return -1;
