...
const citiesAtoJ = (arr) => {
  const RX = /^[A-J]/;
  let temp = arr.filter(city => RX.test(city));
  return temp;
};
...
xdescribe('Testing challenge 9', () => {
  let startString = 'This is a RX challenge. We are trying to create a hangman phrase where all of the vowels are missing!';
